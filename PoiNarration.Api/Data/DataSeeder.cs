...
public static class DataSeeder
{
    ...
    {
        new Booth { Id = "booth-01", ZoneId = "zone-a", NameVi = "Phở Hà Nội", NameEn = "Hanoi Pho", Lat = 10.7768, Lng = 106.7008, RadiusMeters = 25, Priority = 1, IsActive = true, ImageUrl = "http://localhost:7115/uploads/booth/booth-01.png", OwnerUserId = "owner1" },
        new Booth { Id = "booth-02", ZoneId = "zone-a", NameVi = "Bún Bò Huế", NameEn = "Hue Beef Noodles", Lat = 10.77698, Lng = 106.7008, RadiusMeters = 25, Priority = 2, IsActive = true, ImageUrl = "http://localhost:7115/uploads/booth/booth-02.png", OwnerUserId = "owner2" },
        new Booth { Id = "booth-03", ZoneId = "zone-a", NameVi = "Cơm Tấm Sài Gòn", NameEn = "Saigon Broken Rice", Lat = 10.77716, Lng = 106.7008, RadiusMeters = 25, Priority = 3, IsActive = true, ImageUrl = "http://localhost:7115/uploads/booth/booth-03.png", OwnerUserId = "owner3" },
        new Booth { Id = "booth-04", ZoneId = "zone-a", NameVi = "Bánh Mì Việt", NameEn = "Vietnamese Banh Mi", Lat = 10.77734, Lng = 106.7008, RadiusMeters = 25, Priority = 4, IsActive = true, ImageUrl = "http://localhost:7115/uploads/booth/booth-04.png", OwnerUserId = "owner4" },
        new Booth { Id = "booth-05", ZoneId = "zone-a", NameVi = "Chè Ba Miền", NameEn = "Three-Region Sweet Soup", Lat = 10.77752, Lng = 106.7008, RadiusMeters = 25, Priority = 5, IsActive = true, ImageUrl = "http://localhost:7115/uploads/booth/booth-05.png", OwnerUserId = "owner5" },
        new Booth { Id = "booth-06", ZoneId = "zone-b", NameVi = "Nem Nướng Đà Lạt", NameEn = "Dalat Grilled Pork", Lat = 10.7768, Lng = 106.70102, RadiusMeters = 25, Priority = 6, IsActive = true, ImageUrl = "http://localhost:7115/uploads/booth/booth-06.png", OwnerUserId = "owner6" },
        new Booth { Id = "booth-07", ZoneId = "zone-b", NameVi = "Bánh Xèo Miền Tây", NameEn = "Mekong Pancake", Lat = 10.77698, Lng = 106.70102, RadiusMeters = 25, Priority = 7, IsActive = true, ImageUrl = "http://localhost:7115/uploads/booth/booth-07.png", OwnerUserId = "owner7" },
        new Booth { Id = "booth-08", ZoneId = "zone-b", NameVi = "Gỏi Cuốn Tươi", NameEn = "Fresh Spring Rolls", Lat = 10.77716, Lng = 106.70102, RadiusMeters = 25, Priority = 8, IsActive = true, ImageUrl = "http://localhost:7115/uploads/booth/booth-08.png", OwnerUserId = "owner8" },
        new Booth { Id = "booth-09", ZoneId = "zone-b", NameVi = "Hải Sản Nướng", NameEn = "Grilled Seafood", Lat = 10.77734, Lng = 106.70102, RadiusMeters = 25, Priority = 9, IsActive = true, ImageUrl = "http://localhost:7115/uploads/booth/booth-09.png", OwnerUserId = "owner9" },
        new Booth { Id = "booth-10", ZoneId = "zone-b", NameVi = "Cà Phê & Trà Sữa", NameEn = "Coffee & Milk Tea", Lat = 10.77752, Lng = 106.70102, RadiusMeters = 25, Priority = 10, IsActive = true, ImageUrl = "http://localhost:7115/uploads/booth/booth-10.png", OwnerUserId = "owner10" }
    });
            await db.SaveChangesAsync();
        }
        ...
        if (!await db.BoothTranslations.AnyAsync())
        {
            ...
            // --- BOOTH-01: Phở Hà Nội ---
            translations.Add(new BoothTranslationLocal { BoothId = "booth-01", LanguageCode = "vi", Name = "Phở Hà Nội", Description = "Phở Hà Nội - gian hàng nổi bật của hội chợ ẩm thực...", TtsScript = "Xin chào, bạn đang đến với gian hàng Phở Hà Nội.", AudioUrl = "http://localhost:7115/uploads/audio/booth-01-vi.mp3" });
            translations.Add(new BoothTranslationLocal { BoothId = "booth-01", LanguageCode = "en", Name = "Hanoi Pho", Description = "Hanoi Pho booth at the food fair with image menu...", TtsScript = "Welcome to Hanoi Pho.", AudioUrl = "http://localhost:7115/uploads/audio/booth-01-en.mp3" });
            ...
            // --- BOOTH-02: Bún Bò Huế ---
            translations.Add(new BoothTranslationLocal { BoothId = "booth-02", LanguageCode = "vi", Name = "Bún Bò Huế", Description = "Bún Bò Huế - gian hàng nổi bật của hội chợ ẩm thực...", TtsScript = "Xin chào, bạn đang đến với gian hàng Bún Bò Huế.", AudioUrl = "http://localhost:7115/uploads/audio/booth-02-vi.mp3" });
            translations.Add(new BoothTranslationLocal { BoothId = "booth-02", LanguageCode = "en", Name = "Hue Beef Noodles", Description = "Hue Beef Noodles booth at the food fair...", TtsScript = "Welcome to Hue Beef Noodles.", AudioUrl = "http://localhost:7115/uploads/audio/booth-02-en.mp3" });
            ...
            translations.Add(new BoothTranslationLocal { BoothId = "booth-03", LanguageCode = "vi", Name = "Cơm Tấm Sài Gòn", Description = "Cơm Tấm Sài Gòn - gian hàng ẩm thực nổi bật...", TtsScript = "Xin chào, bạn đang đến với gian hàng Cơm Tấm Sài Gòn.", AudioUrl = "http://localhost:7115/uploads/audio/booth-03-vi.mp3" });
            translations.Add(new BoothTranslationLocal { BoothId = "booth-03", LanguageCode = "en", Name = "Saigon Broken Rice", Description = "Saigon Broken Rice booth at the food fair...", TtsScript = "Welcome to Saigon Broken Rice.", AudioUrl = "http://localhost:7115/uploads/audio/booth-03-en.mp3" });
            ...
            translations.Add(new BoothTranslationLocal { BoothId = "booth-04", LanguageCode = "vi", Name = "Bánh Mì Việt", Description = "Bánh Mì Việt - gian hàng ẩm thực nổi bật...", TtsScript = "Xin chào, bạn đang đến với gian hàng Bánh Mì Việt.", AudioUrl = "http://localhost:7115/uploads/audio/booth-04-vi.mp3" });
            translations.Add(new BoothTranslationLocal { BoothId = "booth-04", LanguageCode = "en", Name = "Vietnamese Banh Mi", Description = "Vietnamese Banh Mi booth at the food fair...", TtsScript = "Welcome to Vietnamese Banh Mi.", AudioUrl = "http://localhost:7115/uploads/audio/booth-04-en.mp3" });
            ...
            translations.Add(new BoothTranslationLocal { BoothId = "booth-05", LanguageCode = "vi", Name = "Chè Ba Miền", Description = "Chè Ba Miền - gian hàng ẩm thực nổi bật...", TtsScript = "Xin chào, bạn đang đến với gian hàng Chè Ba Miền.", AudioUrl = "http://localhost:7115/uploads/audio/booth-05-vi.mp3" });
            translations.Add(new BoothTranslationLocal { BoothId = "booth-05", LanguageCode = "en", Name = "Three-Region Sweet Soup", Description = "Three-Region Sweet Soup booth...", TtsScript = "Welcome to Three-Region Sweet Soup.", AudioUrl = "http://localhost:7115/uploads/audio/booth-05-en.mp3" });
            ...
            translations.Add(new BoothTranslationLocal { BoothId = "booth-06", LanguageCode = "vi", Name = "Nem Nướng Đà Lạt", Description = "Nem Nướng Đà Lạt - gian hàng nổi bật của hội chợ ẩm thực...", TtsScript = "Xin chào, bạn đang đến với gian hàng Nem Nướng Đà Lạt.", AudioUrl = "http://localhost:7115/uploads/audio/booth-06-vi.mp3" });
            translations.Add(new BoothTranslationLocal { BoothId = "booth-06", LanguageCode = "en", Name = "Dalat Grilled Pork Rolls", Description = "Dalat Grilled Pork Rolls booth at the food fair...", TtsScript = "Welcome to Dalat Grilled Pork Rolls.", AudioUrl = "http://localhost:7115/uploads/audio/booth-06-en.mp3" });
            ...
            translations.Add(new BoothTranslationLocal { BoothId = "booth-07", LanguageCode = "vi", Name = "Bánh Xèo Miền Tây", Description = "Bánh Xèo Miền Tây - gian hàng nổi bật của hội chợ ẩm thực...", TtsScript = "Xin chào, bạn đang đến với gian hàng Bánh Xèo Miền Tây.", AudioUrl = "http://localhost:7115/uploads/audio/booth-07-vi.mp3" });
            translations.Add(new BoothTranslationLocal { BoothId = "booth-07", LanguageCode = "en", Name = "Mekong Crispy Pancake", Description = "Mekong Crispy Pancake booth at the food fair...", TtsScript = "Welcome to Mekong Crispy Pancake.", AudioUrl = "http://localhost:7115/uploads/audio/booth-07-en.mp3" });
            ...
            translations.Add(new BoothTranslationLocal { BoothId = "booth-08", LanguageCode = "vi", Name = "Gỏi Cuốn Tươi", Description = "Gỏi Cuốn Tươi - gian hàng nổi bật của hội chợ ẩm thực...", TtsScript = "Xin chào, bạn đang đến với gian hàng Gỏi Cuốn Tươi.", AudioUrl = "http://localhost:7115/uploads/audio/booth-08-vi.mp3" });
            translations.Add(new BoothTranslationLocal { BoothId = "booth-08", LanguageCode = "en", Name = "Fresh Spring Rolls", Description = "Fresh Spring Rolls booth at the food fair...", TtsScript = "Welcome to Fresh Spring Rolls.", AudioUrl = "http://localhost:7115/uploads/audio/booth-08-en.mp3" });
            ...
            translations.Add(new BoothTranslationLocal { BoothId = "booth-09", LanguageCode = "vi", Name = "Hải Sản Nướng", Description = "Hải Sản Nướng - gian hàng nổi bật của hội chợ ẩm thực...", TtsScript = "Xin chào, bạn đang đến với gian hàng Hải Sản Nướng.", AudioUrl = "http://localhost:7115/uploads/audio/booth-09-vi.mp3" });
            translations.Add(new BoothTranslationLocal { BoothId = "booth-09", LanguageCode = "en", Name = "Grilled Seafood", Description = "Grilled Seafood booth at the food fair...", TtsScript = "Welcome to Grilled Seafood.", AudioUrl = "http://localhost:7115/uploads/audio/booth-09-en.mp3" });
            ...
            translations.Add(new BoothTranslationLocal { BoothId = "booth-10", LanguageCode = "vi", Name = "Cà Phê & Trà Sữa", Description = "Cà Phê & Trà Sữa - gian hàng nổi bật của hội chợ ẩm thực...", TtsScript = "Xin chào, bạn đang đến với gian hàng Cà Phê & Trà Sữa.", AudioUrl = "http://localhost:7115/uploads/audio/booth-10-vi.mp3" });
            translations.Add(new BoothTranslationLocal { BoothId = "booth-10", LanguageCode = "en", Name = "Coffee & Milk Tea", Description = "Coffee & Milk Tea booth at the food fair...", TtsScript = "Welcome to Coffee & Milk Tea.", AudioUrl = "http://localhost:7115/uploads/audio/booth-10-en.mp3" });
        ...
        if (!await db.BoothMenuItems.AnyAsync())
        {
            ...
            // --- Booth 01: Phở Hà Nội ---
            menuItems.Add(new BoothMenuItem { Id = "booth-01-menu-01", BoothId = "booth-01", Name = "Phở Đặc Biệt", NameEn = "Pho Special", Description = "Phở đặc biệt đầy đủ topping.", DescriptionEn = "Pho Special item for demo.", Price = 65000m, PriceUsd = 2.60m, ImageUrl = "http://localhost:7115/uploads/menu/booth-01-menu-01.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-01-menu-02", BoothId = "booth-01", Name = "Phở Tái Nạm", NameEn = "Rare & Brisket Pho", Description = "Phở tái nạm tươi ngon.", DescriptionEn = "Rare & Brisket Pho item.", Price = 72000m, PriceUsd = 2.88m, ImageUrl = "http://localhost:7115/uploads/menu/booth-01-menu-02.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-01-menu-03", BoothId = "booth-01", Name = "Phở Bò Viên", NameEn = "Meatball Pho", Description = "Phở bò viên dai giòn.", DescriptionEn = "Meatball Pho item.", Price = 59000m, PriceUsd = 2.36m, ImageUrl = "http://localhost:7115/uploads/menu/booth-01-menu-03.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });

            // --- Booth 02: Bún Bò Huế ---
            menuItems.Add(new BoothMenuItem { Id = "booth-02-menu-01", BoothId = "booth-02", Name = "Bún Bò Đặc Biệt", NameEn = "Special Hue Noodles", Description = "Bún bò Huế đặc biệt.", DescriptionEn = "Special Hue Noodles item.", Price = 68000m, PriceUsd = 2.72m, ImageUrl = "http://localhost:7115/uploads/menu/booth-02-menu-01.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-02-menu-02", BoothId = "booth-02", Name = "Bún Bò Giò Heo", NameEn = "Hue Noodles with Pork Hock", Description = "Bún bò giò heo đặc trưng.", DescriptionEn = "Hue Noodles with Pork Hock item.", Price = 75000m, PriceUsd = 3.00m, ImageUrl = "http://localhost:7115/uploads/menu/booth-02-menu-02.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-02-menu-03", BoothId = "booth-02", Name = "Bún Bò Thập Cẩm", NameEn = "Mixed Hue Noodles", Description = "Bún bò thập cẩm đầy đủ.", DescriptionEn = "Mixed Hue Noodles item.", Price = 79000m, PriceUsd = 3.16m, ImageUrl = "http://localhost:7115/uploads/menu/booth-02-menu-03.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });

            // --- Booth 03: Cơm Tấm Sài Gòn ---
            menuItems.Add(new BoothMenuItem { Id = "booth-03-menu-01", BoothId = "booth-03", Name = "Cơm Tấm Sườn Bì Chả", NameEn = "Broken Rice Combo", Description = "Cơm tấm sườn bì chả truyền thống.", DescriptionEn = "Broken Rice Combo item.", Price = 62000m, PriceUsd = 2.48m, ImageUrl = "http://localhost:7115/uploads/menu/booth-03-menu-01.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-03-menu-02", BoothId = "booth-03", Name = "Cơm Tấm Sườn Nướng", NameEn = "Broken Rice Grilled Pork", Description = "Sườn nướng thơm ngon.", DescriptionEn = "Broken Rice Grilled Pork item.", Price = 69000m, PriceUsd = 2.76m, ImageUrl = "http://localhost:7115/uploads/menu/booth-03-menu-02.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-03-menu-03", BoothId = "booth-03", Name = "Cơm Tấm Đặc Biệt", NameEn = "Special Broken Rice", Description = "Cơm tấm đặc biệt.", DescriptionEn = "Special Broken Rice item.", Price = 79000m, PriceUsd = 3.16m, ImageUrl = "http://localhost:7115/uploads/menu/booth-03-menu-03.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });

            // --- Booth 04: Bánh Mì Việt ---
            menuItems.Add(new BoothMenuItem { Id = "booth-04-menu-01", BoothId = "booth-04", Name = "Bánh Mì Thịt Nướng", NameEn = "Grilled Pork Banh Mi", Description = "Bánh mì kẹp thịt nướng.", DescriptionEn = "Grilled Pork Banh Mi item.", Price = 35000m, PriceUsd = 1.40m, ImageUrl = "http://localhost:7115/uploads/menu/booth-04-menu-01.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-04-menu-02", BoothId = "booth-04", Name = "Bánh Mì Gà", NameEn = "Chicken Banh Mi", Description = "Bánh mì gà xé.", DescriptionEn = "Chicken Banh Mi item.", Price = 38000m, PriceUsd = 1.52m, ImageUrl = "http://localhost:7115/uploads/menu/booth-04-menu-02.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-04-menu-03", BoothId = "booth-04", Name = "Bánh Mì Đặc Biệt", NameEn = "Special Banh Mi", Description = "Bánh mì đặc biệt đầy đủ.", DescriptionEn = "Special Banh Mi item.", Price = 45000m, PriceUsd = 1.80m, ImageUrl = "http://localhost:7115/uploads/menu/booth-04-menu-03.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });

            // --- Booth 05: Chè Ba Miền ---
            menuItems.Add(new BoothMenuItem { Id = "booth-05-menu-01", BoothId = "booth-05", Name = "Chè Đậu Xanh", NameEn = "Mung Bean Sweet Soup", Description = "Chè đậu xanh thanh mát.", DescriptionEn = "Mung Bean Sweet Soup item.", Price = 28000m, PriceUsd = 1.12m, ImageUrl = "http://localhost:7115/uploads/menu/booth-05-menu-01.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-05-menu-02", BoothId = "booth-05", Name = "Chè Thập Cẩm", NameEn = "Mixed Sweet Soup", Description = "Chè thập cẩm đủ loại.", DescriptionEn = "Mixed Sweet Soup item.", Price = 32000m, PriceUsd = 1.28m, ImageUrl = "http://localhost:7115/uploads/menu/booth-05-menu-02.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-05-menu-03", BoothId = "booth-05", Name = "Chè Dừa Non", NameEn = "Young Coconut Sweet Soup", Description = "Chè dừa non béo ngậy.", DescriptionEn = "Young Coconut Sweet Soup item.", Price = 36000m, PriceUsd = 1.44m, ImageUrl = "http://localhost:7115/uploads/menu/booth-05-menu-03.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });

            // --- Booth 06: Nem Nướng Đà Lạt ---
            menuItems.Add(new BoothMenuItem { Id = "booth-06-menu-01", BoothId = "booth-06", Name = "Nem Nướng Phần", NameEn = "Grilled Pork Rolls Set", Description = "Nem nướng đặc sản Đà Lạt.", DescriptionEn = "Grilled Pork Rolls Set item.", Price = 68000m, PriceUsd = 2.72m, ImageUrl = "http://localhost:7115/uploads/menu/booth-06-menu-01.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-06-menu-02", BoothId = "booth-06", Name = "Nem Nướng Combo", NameEn = "Grilled Pork Combo", Description = "Combo nem nướng hấp dẫn.", DescriptionEn = "Grilled Pork Combo item.", Price = 79000m, PriceUsd = 3.16m, ImageUrl = "http://localhost:7115/uploads/menu/booth-06-menu-02.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-06-menu-03", BoothId = "booth-06", Name = "Nem Nướng Đặc Biệt", NameEn = "Special Grilled Pork Rolls", Description = "Nem nướng đặc biệt.", DescriptionEn = "Special Grilled Pork Rolls item.", Price = 89000m, PriceUsd = 3.56m, ImageUrl = "http://localhost:7115/uploads/menu/booth-06-menu-03.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });

            // --- Booth 07: Bánh Xèo Miền Tây ---
            menuItems.Add(new BoothMenuItem { Id = "booth-07-menu-01", BoothId = "booth-07", Name = "Bánh Xèo Tôm Thịt", NameEn = "Shrimp Pork Pancake", Description = "Bánh xèo nhân tôm thịt.", DescriptionEn = "Shrimp Pork Pancake item.", Price = 65000m, PriceUsd = 2.60m, ImageUrl = "http://localhost:7115/uploads/menu/booth-07-menu-01.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-07-menu-02", BoothId = "booth-07", Name = "Bánh Xèo Chay", NameEn = "Vegetarian Pancake", Description = "Bánh xèo nhân đậu xanh.", DescriptionEn = "Vegetarian Pancake item.", Price = 58000m, PriceUsd = 2.32m, ImageUrl = "http://localhost:7115/uploads/menu/booth-07-menu-02.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-07-menu-03", BoothId = "booth-07", Name = "Bánh Xèo Đặc Biệt", NameEn = "Special Pancake", Description = "Bánh xèo đặc biệt siêu to.", DescriptionEn = "Special Pancake item.", Price = 76000m, PriceUsd = 3.04m, ImageUrl = "http://localhost:7115/uploads/menu/booth-07-menu-03.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });

            // --- Booth 08: Gỏi Cuốn Tươi ---
            menuItems.Add(new BoothMenuItem { Id = "booth-08-menu-01", BoothId = "booth-08", Name = "Gỏi Cuốn Tôm Thịt", NameEn = "Shrimp Pork Spring Rolls", Description = "Gỏi cuốn tôm thịt tươi ngon.", DescriptionEn = "Shrimp Pork Spring Rolls item.", Price = 42000m, PriceUsd = 1.68m, ImageUrl = "http://localhost:7115/uploads/menu/booth-08-menu-01.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-08-menu-02", BoothId = "booth-08", Name = "Gỏi Cuốn Bò Nướng", NameEn = "Beef Spring Rolls", Description = "Gỏi cuốn nhân bò nướng.", DescriptionEn = "Beef Spring Rolls item.", Price = 48000m, PriceUsd = 1.92m, ImageUrl = "http://localhost:7115/uploads/menu/booth-08-menu-02.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-08-menu-03", BoothId = "booth-08", Name = "Combo 6 Cuốn", NameEn = "6-roll Combo", Description = "Combo 6 cuốn đầy đủ.", DescriptionEn = "6-roll Combo item.", Price = 75000m, PriceUsd = 3.00m, ImageUrl = "http://localhost:7115/uploads/menu/booth-08-menu-03.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });

            // --- Booth 09: Hải Sản Nướng ---
            menuItems.Add(new BoothMenuItem { Id = "booth-09-menu-01", BoothId = "booth-09", Name = "Mực Nướng Sa Tế", NameEn = "Grilled Squid", Description = "Mực nướng sa tế cay nồng.", DescriptionEn = "Grilled Squid item.", Price = 98000m, PriceUsd = 3.92m, ImageUrl = "http://localhost:7115/uploads/menu/booth-09-menu-01.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-09-menu-02", BoothId = "booth-09", Name = "Tôm Nướng Muối Ớt", NameEn = "Grilled Shrimp", Description = "Tôm nướng muối ớt đậm đà.", DescriptionEn = "Grilled Shrimp item.", Price = 115000m, PriceUsd = 4.60m, ImageUrl = "http://localhost:7115/uploads/menu/booth-09-menu-02.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-09-menu-03", BoothId = "booth-09", Name = "Combo Hải Sản", NameEn = "Seafood Combo", Description = "Combo hải sản nướng thập cẩm.", DescriptionEn = "Seafood Combo item.", Price = 149000m, PriceUsd = 5.96m, ImageUrl = "http://localhost:7115/uploads/menu/booth-09-menu-03.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });

            // --- Booth 10: Cà Phê & Trà Sữa ---
            menuItems.Add(new BoothMenuItem { Id = "booth-10-menu-01", BoothId = "booth-10", Name = "Cà Phê Sữa Đá", NameEn = "Iced Milk Coffee", Description = "Cà phê sữa đá truyền thống.", DescriptionEn = "Iced Milk Coffee item.", Price = 30000m, PriceUsd = 1.20m, ImageUrl = "http://localhost:7115/uploads/menu/booth-10-menu-01.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-10-menu-02", BoothId = "booth-10", Name = "Trà Sữa Trân Châu", NameEn = "Bubble Milk Tea", Description = "Trà sữa trân châu đường đen.", DescriptionEn = "Bubble Milk Tea item.", Price = 42000m, PriceUsd = 1.68m, ImageUrl = "http://localhost:7115/uploads/menu/booth-10-menu-02.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
            menuItems.Add(new BoothMenuItem { Id = "booth-10-menu-03", BoothId = "booth-10", Name = "Combo Đồ Uống", NameEn = "Drink Combo", Description = "Combo cà phê và trà sữa.", DescriptionEn = "Drink Combo item.", Price = 70000m, PriceUsd = 2.80m, ImageUrl = "http://localhost:7115/uploads/menu/booth-10-menu-03.png", UpdatedAtUtc = DateTime.UtcNow, IsDeleted = false });
